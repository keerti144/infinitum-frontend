...
export default function HeroGeometric() {
  ...
  const isInView = useInView(ref, { once: true, margin: "-100px" }) // Animate once when in view
  ...
  return (
    <div ref={ref} className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
